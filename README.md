...
<div align="center">
  ...
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&duration=3200&pause=900&color=58A6FF&center=true&vCenter=true&width=680&lines=11%2B+years+in+Manufacturing+IT;MES+%C2%B7+SPC+%C2%B7+RMS+%C2%B7+MMS+%C2%B7+ERP+%C2%B7+HACCP;Java+%2F+Spring+Boot+Backend+Lead;Turning+factory+data+into+systems." alt="Typing SVG" />
  </a>
...
```mermaid
timeline
    title 11년 6개월의 제조 IT 여정
    2014 ~ 2015 : 아이티센 — 공공 SI · 국세청 홈택스 장애대응
    2015 ~ 2019 : 에임시스템 — SPC / MES / EWS / ATS
                : 중국 우한 CSOT · 중국 쿤밍 BOE 파견
    2019 ~ 2021 : 티라유텍 — SKC솔믹스 SPC (PL) · SK하이닉스 GRMS · AI 머신러닝
    2021 ~ 2023 : 프로젝트바닐라 / 뽀득 / 미라콤 — 증권 API · ERP PM · 반도체 WLS
    2023 ~ 2024 : CJ올리브네트웍스 — 화요 MES·HACCP · CJ제일제당 BMP
    2024 ~ Now  : eMoldino — MMS Application Lead (Global SaaS)
```
